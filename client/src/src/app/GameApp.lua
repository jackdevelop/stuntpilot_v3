...
function UIDemoApp:run()
    ...
    local sceneName,backScaneName,isPhysicsWorld = SceneConstants.FightLoadingScene();
    self:enterScene(sceneName,backScaneName,isPhysicsWorld)
...
function UIDemoApp:enterScene(sceneName,backScaneName,isPhysicsWorld, param,...)
	local function enterSceneFun(sceneName, args, transitionType, time, more)
	    local scenePackageName = self. packageRoot .. ".scenes." .. sceneName
	    UIDemoApp.isPhysicsWorld = isPhysicsWorld;
