...
local defines = {
	...
	FlowMapCameraBehavior = require("app.gameObject.behavior.FlowMapCameraBehavior"),
	...
	BoxCollideMovableBehavior = require("app.gameObject.behavior.BoxCollideMovableBehavior"),
