--[[
 	AnimationProperties
 	public ->> 全局公开类
 	完全重写父类的  engin/config/properties/AnimationProperties.lua
...
--角色动画
local decoration = {
	animationType	=	AnimationFactory.ccs_type,
	animationParam={
		png ="animation/zhujiao.png", --png地址
		plist = "animation/zhujiao.plist", --plist地址
		json = "animation/zhujiao.json", --json地址
		name = "dongzuo1",--动画名称
		actionName ="chuanqidz"
	},
    -- 以下为都为可选设定
...
--飞机动画
local decoration = {
	animationType   = AnimationFactory.sprite_type,
